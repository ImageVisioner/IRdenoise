...
It is worth noting that the modeling Gaussian noise not shown in the uploaded code is included in the Poisson noise. You can safely use the modified code.     
